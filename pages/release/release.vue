    ...
    <view>
        <view class="authent" v-if="pageauth">
            ...
            <!-- 上传封面图 -->
         	  <view>
                ...
                <!-- 上传图片 -->
                    ...
                    <view class="topimg">
                        <image src="../../static/img/topimg.png" mode="widthFix" @click="uploadImg(fengmian,manyfeng)">
                        </image>
                    </view>
        		          <!-- 上传封面 -->
                    <view class="conteng">
                        <block v-for="(item,index) in Coverimg" :key="index">
                            <view class="conteng-img">
                                <image :src="item" mode="aspectFill" class="uploadimg"></image>
          					                 <image src="../../static/img/deteimg.svg" mode="widthFix" class="deleteimg"
                                    @click="deleteImg(index,fengmian)"></image>
                            </view>
                        </block>
                    </view>
                </view>
            ...
            <!-- 上传轮播图 -->
          	 <view>
                ...
                <!-- 上传图片 -->
        		      <view class="travels-image">
          			       <view class="topimg">
        		              <image src="../../static/img/topimg.png" mode="widthFix" @click="uploadImg(lunbo,manylun)">
                        </image>
                    </view>
                    <!-- 上传的图片 -->
                    <view class="conteng">
                        <block v-for="(item,index) in Banner" :key="index">
                            <view class="conteng-img">
                                <image :src="item" mode="aspectFill" class="uploadimg"></image>
                                <image src="../../static/img/deteimg.svg" mode="widthFix" class="deleteimg"
                                    @click="deleteImg(index,lunbo)"></image>
                            </view>
                        </block>
            			     </view>
          		    </view>
            ...
            <view>
                ...
                <view class="travels-image">
                    <view class="topimg">
                        <image src="../../static/img/topimg.png" mode="widthFix" @click="uploadImg(xiangqing,manylun)">
                        </image>
                    </view>
        			         <!-- 上传的图片 -->
                    <view class="conteng">
                        <block v-for="(item,index) in Details" :key="index">
                            <view class="conteng-img">
                                <image :src="item" mode="aspectFill" class="uploadimg"></image>
                                <image src="../../static/img/deteimg.svg" mode="widthFix" class="deleteimg"
                                    @click="deleteImg(index,xiangqing)"></image>
                            </view>
                        </block>
                    </view>
                </view>
        ...
        methods: {
            ...
            ifUser(){
                ...
                .then(res=>{
                    ...
                    if(username.examine != 'success' || res.data.length == 0){
                        // 没有认证
                        this.pageauth = false
                        let staimg = '../static/img/tishidat.svg'
                        let title = '认证商家才可以发布商品哦'
